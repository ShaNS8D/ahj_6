...
class CardController {
  ...
  setupEventListeners() {
    this.eventListeners.push(this.container.addEventListener("click", this.onClickDeleteCard.bind(this)), this.container.addEventListener("click", this.onClickPinCard.bind(this)), this.container.addEventListener("click", this.deletePinnedCard.bind(this)), this.container.addEventListener("mouseover", e => this.onMouseOver(e)), this.container.addEventListener("mouseout", e => this.onMouseOut(e)), this.container.addEventListener("mousedown", e => this.dragDown(e)), this.container.addEventListener("mousemove", e => this.dragMove(e)), this.container.addEventListener("mouseup", e => this.dragUp(e)), this.container.addEventListener("mouseleave", e => this.dragLeave(e)));
  }
  ...
  dragDown(e) {
    ...
    this.initialPosition = {
      ...
      index: Array.from(dragElement.parentElement.children).indexOf(dragElement)
    };
    const {
      width,
      height,
  ...
  dragMove(e) {
    ...
    if (insertBeforeElement && !insertBeforeElement.classList.contains("dragged")) {
  ...
  dragUp(e) {
    if (!this.dragEl || !this.placeholder) return;
    const targetCardCell = document.elementFromPoint(e.clientX, e.clientY)?.closest(".cards-container");
    if (!targetCardCell) {
  ...
  returnToInitialPosition() {
    ...
    this.initialPosition.parent.insertBefore(this.dragEl, this.initialPosition.parent.children[this.initialPosition.index]);
    this.dragEl.style.position = "";
    this.dragEl.style.top = "";
    this.dragEl.style.left = "";
    this.dragEl.style.width = "";
  ...
  updateState() {
    ...
    columns.forEach(column => {
      ...
      const cards = Array.from(column.querySelectorAll(".pinned__card")).map(card => ({
